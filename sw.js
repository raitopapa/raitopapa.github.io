// 樹木管理ナビ Service Worker v3.15
const CACHE_NAME = 'arborist-tools-v3.15';
...
const CACHE_FILES = [
  ...
  '/embed/pruning.html',
  '/blog/',
  '/blog/2026/05/04/pruning-season-basic/',
  '/blog/2026/05/04/leaf-yellowing-check/',
  '/blog/2026/05/04/tree-inspection-record/',
  '/feed.xml',
  '/privacy.html',
  '/contact.html',
  ...
  '/assets/js/i18n.js',
  '/assets/js/layout.js',
  '/assets/data/internal-links.json',
  '/assets/images/hero/hero-tree-canopy.jpg',
  '/assets/i18n/ja.json',
  '/assets/i18n/en.json',
...
self.addEventListener('install', event => {
  console.log('[SW] Installing v3.15...');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[SW] Activating v3.15...');
  event.waitUntil(
